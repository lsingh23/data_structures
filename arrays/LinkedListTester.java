 ...
 *
 */
public class LinkedListTester extends JFrame implements ActionListener {
	...
	public LinkedListTester() {
		...
		student_record = new StudentContainer();//initialize the StudentConatiner using it's constructor
	...
	public static void main(String[] args) throws Exception {
 		...
 		LinkedListTester window = new LinkedListTester();
		...
		if(e.getSource()==select) {
			...
			if(returnVal == JFileChooser.APPROVE_OPTION)
			{
				...
				try {
					...
					student_record = new StudentContainer();
